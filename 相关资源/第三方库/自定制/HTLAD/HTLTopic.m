...
#import "HTLTopic.h"
@implementation HTLTopic
@synthesize HTLdelegate;
...
-(void)click:(id)sender{
    [HTLdelegate didClick:[self.pics objectAtIndex:[sender tag]]];
}
- (void)scrollViewDidScroll:(UIScrollView *)scrollView{
    ...
    [HTLdelegate currentPage:currentPage total:[self.pics count]-2];
